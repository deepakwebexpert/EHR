    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <?php echo form_open(base_url('admin/users/add_my_domestic_travel_claim/' . $id), 'class="form-horizontal"');  ?>
                    ...
                    <table id="addedRows" class="table table-bordered table-striped table-hover">
                        ...
                        for ($j = 1; $j <= 10; $j++) { ?>
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" value="" name="travel_date[]" <?php if ($j == 1) echo "required" ?>>
                                </td>

                                <td>

                                    <select class="form-control show-tick live_search department_change" name="app_teamleader" required>
                                ...
                                <td>
                                    <input type="file" class="form-control" value="" name="travel_date[]" <?php if ($j == 1) echo "required" ?>>
                                </td>
                            </tr>
