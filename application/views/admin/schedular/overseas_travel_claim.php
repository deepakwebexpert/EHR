        ...
        <div class="card">
            ...
            <div class="body">
                ...
                ?>
                    ...
                    <select class="" onChange="window.location='<?= base_url('admin/users/overseas_travel_claim') ?>/'+this.value">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr style="background-color:<?= $color ?>">
                                        ...
                                        <td class="c">
                                            <!-- <a href="<?php echo base_url() ?>travel/search_overseasTwo/<?= $value['sheet_id'] ?>">View</a> -->
                                            #
                                        </td>
                                    </tr>
                                    <?php
