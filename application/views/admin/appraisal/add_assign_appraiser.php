        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    ...
                    <?php echo form_open(base_url('admin/appraisal/add_asign_appraisar/' . $id), 'class="form-horizontal"');  ?>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label for="username">Select Final Appraiser</label>
                        </div>
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <select class="form-control show-tick live_search department_change" data-live-search="true" name="app_final" required>
                                        <!-- <option value="">-- Please select --</option> -->
                                        <?php foreach ($employee as $group) : ?>
                                            <option value="<?= $group['id']; ?>" <?= ($department['app_final'] == $group['id'] ? 'selected' : '') ?>><?= $group['emp_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
