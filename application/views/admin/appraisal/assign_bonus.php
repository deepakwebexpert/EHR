    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?= base_url('admin/appraisal/add_assign_bonus'); ?>" class="btn bg-deep-orange waves-effect pull-right"><i class="material-icons">person_add</i> Add New</a>
            </div>
            <div class="body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="c">
                                        <a title="Edit" class="update btn btn-sm btn-primary m-r-10" href=<?= base_url('admin/appraisal/add_assign_bonus/' . $row['id']) ?>>
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a title="Delete" class="delete btn btn-sm btn-danger ' . $disabled . '" data-href=<?= base_url('admin/appraisal/del_assign_bonus/' . $row['id']) ?> data-toggle="modal" data-target="#confirm-delete">
