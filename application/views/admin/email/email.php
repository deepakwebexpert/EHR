...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Schedule Mail Listing
                </h2>
                <a href="<?= base_url('admin/email/add_schedule'); ?>" class="btn bg-deep-orange waves-effect pull-right"><i class="material-icons">person_add</i> Add New</a>
            </div>
            <div class="body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="c">
                                        <a class="btn btn-primary" href="<?= (base_url('admin/email/add_schedule/' . $row['id'])) ?>"><i class="material-icons">edit</i></a> <a class="delete btn btn-sm btn-danger"  href=""><i class="material-icons">delete</i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
